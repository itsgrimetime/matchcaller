...
from .match import MatchData, PlayerData, TournamentState
...
MOCK_TOURNAMENT_DATA: TournamentState = TournamentState(
    ...
    sets=[
        ...
        MatchData(
            ...
            phase_group="Winners Bracket",
            phase_name="Winners Bracket",
            player1=PlayerData(tag="Charlie", id=3),
            player2=PlayerData(tag="Dave", id=4),
            state=6,  # In progress
        ...
        MatchData(
            ...
            player1=PlayerData(tag="Eve", id=5),
            player2=PlayerData(tag="Frank", id=6),
            state=1,  # Not started
        ...
        MatchData(
            ...
            phase_group="Finals",
            phase_name="Finals",
            player1=PlayerData(tag="Winner A", id=7),
            player2=PlayerData(tag="Winner B", id=8),
            state=1,  # Not started
