...
class TestUISnapshots:
    ...
    def test_demo_mode_initial_display_snapshot(self, snap_compare):
        ...
        assert snap_compare(
            "test_app_stable.py:StableTournamentDisplay", terminal_size=(120, 30)
        )
    ...
    def test_custom_tournament_data_snapshot(self, snap_compare):
        ...
        assert snap_compare(
            "test_app_stable.py:StableTournamentDisplay", terminal_size=(140, 35)
        )

    def test_empty_tournament_snapshot(self, snap_compare):
        """Test display when tournament has no active matches"""
        assert snap_compare(
            "test_app_empty.py:EmptyTournamentDisplay", terminal_size=(120, 25)
        )
    ...
    def test_error_state_snapshot(self, snap_compare):
        ...
        assert snap_compare(
            "test_app_stable.py:StableTournamentDisplay", terminal_size=(120, 25)
        )
    ...
    def test_raspberry_pi_display_size(self, snap_compare):
        ...
        assert snap_compare(
            "test_app_stable.py:StableTournamentDisplay", terminal_size=(50, 15)
        )
